...
import 'package:sistem_akademik/model/model_login.dart';
import 'package:sistem_akademik/screen_page/home.dart';
import 'package:sistem_akademik/screen_page/register.dart';
import 'package:sistem_akademik/utils/cek_sassion.dart';
import 'package:sistem_akademik/utils/ip.dart';
// 'package:sistem_akademik/utils/cek_session.dart';
  ...
  Future<Modellogin?> loginAccount() async {
    try {
      ...
      http.Response res = await http
          .post(Uri.parse('$ip/login.php'), body: {
